        ...
        manager
            .exec_stmt(
                Query::insert()
                    ...
                    .columns([
                        Ride::RideID, Ride::Name, Ride::Image, Ride::Description,
                        Ride::Location, Ride::Status, Ride::Capacity, Ride::MaintenanceStatus,
                    ])
                    .values_panic([ 
                        "RI001".into(), "Horse Carousel".into(), ride1_img.into(),
                    ...
                    .values_panic([ 
                        "RI002".into(), "Spinning Swing".into(), ride2_img.into(),
                    ...
                    .values_panic([ 
                        "RI003".into(), "Boom Boom Car".into(), ride3_img.into(),
                    ...
                    .values_panic([ 
                        "RI004".into(), "Ferris Wheel".into(), ride4_img.into(),
                    ...
                    .values_panic([ 
                        "RI005".into(), "Roller Coaster".into(), ride5_img.into(),
