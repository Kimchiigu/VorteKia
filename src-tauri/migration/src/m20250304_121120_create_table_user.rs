        ...
        manager
            .exec_stmt(
                Query::insert()
                    ...
                    .columns([
                        User::UserID, User::Name, User::Email, User::DOB, 
                    ...
                    .values_panic([ 
                        ...
                        "1980-06-15".into(), "CEO".into(), 10000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "COO-001".into(), "Michael Tan".into(), "michael.tan@vortekia.com".into(), 
                        "1985-12-05".into(), "COO".into(), 8000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CFO-001".into(), "Alexander Jason".into(), "alexander.jason@vortekia.com".into(), 
                        "1985-12-05".into(), "CFO".into(), 9000.00.into(), None::<String>.into(),
                    ])
                    // Customer (5 Users)
                    .values_panic([ 
                        "CUS-001".into(), "Alexandra Smith".into(), "alexandra.smith@vortekia.com".into(), 
                        "1990-03-10".into(), "Customer".into(), 250.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CUS-002".into(), "Benjamin Lee".into(), "benjamin.lee@vortekia.com".into(), 
                        "1993-04-18".into(), "Customer".into(), 300.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CUS-003".into(), "Sophia Wong".into(), "sophia.wong@vortekia.com".into(), 
                        "1994-07-22".into(), "Customer".into(), 400.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CUS-004".into(), "Daniel Chia".into(), "daniel.chia@vortekia.com".into(), 
                        "1995-01-05".into(), "Customer".into(), 150.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CUS-005".into(), "Emily Tan".into(), "emily.tan@vortekia.com".into(), 
                        "1996-09-08".into(), "Customer".into(), 500.00.into(), None::<String>.into(),
                    ])
                    // Customer Service Manager (5 Users)
                    .values_panic([ 
                        "CSM-001".into(), "Alice Johnson".into(), "alice.johnson@vortekia.com".into(), 
                        "1991-03-12".into(), "Customer Service Manager".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSM-002".into(), "Alice Johnson".into(), "alice.johnson001@vortekia.com".into(), 
                        "1991-03-12".into(), "Customer Service Manager".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSM-003".into(), "Alice Johnson".into(), "alice.johnson002@vortekia.com".into(), 
                        "1991-03-12".into(), "Customer Service Manager".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSM-004".into(), "Alice Johnson".into(), "alice.johnson003@vortekia.com".into(), 
                        "1991-03-12".into(), "Customer Service Manager".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSM-005".into(), "Alice Johnson".into(), "alice.johnson004@vortekia.com".into(), 
                        "1991-03-12".into(), "Customer Service Manager".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    // Customer Service Staff (5 Users)
                    .values_panic([ 
                        "CSS-001".into(), "Alice Johnson".into(), "alice.johnson005@vortekia.com".into(), 
                        "1991-03-12".into(), "Customer Service Staff".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSS-002".into(), "Brian Smith".into(), "brian.smith@vortekia.com".into(), 
                        "1990-05-20".into(), "Customer Service Staff".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSS-003".into(), "Clara Davis".into(), "clara.davis@vortekia.com".into(), 
                        "1992-07-08".into(), "Customer Service Staff".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSS-004".into(), "Daniel Brown".into(), "daniel.brown@vortekia.com".into(), 
                        "1993-09-15".into(), "Customer Service Staff".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "CSS-005".into(), "Emma Wilson".into(), "emma.wilson@vortekia.com".into(), 
                        "1994-11-25".into(), "Customer Service Staff".into(), 4500.00.into(), None::<String>.into(),
                    ])
                    // Lost And Found Staff (5 Users)
                    .values_panic([ 
                        "LFS-001".into(), "Christopher Gunawan".into(), "christopher.gunawan@vortekia.com".into(), 
                        "1992-09-23".into(), "Lost And Found Staff".into(), 5000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                    ...
                    .values_panic([ 
                        ...
                        "1989-02-10".into(), "Ride Manager".into(), 6000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "RIM-002".into(), "Laura Mitchell".into(), "laura.mitchell@vortekia.com".into(), 
                        "1990-04-17".into(), "Ride Manager".into(), 6000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "RIM-003".into(), "Matthew Scott".into(), "matthew.scott@vortekia.com".into(), 
                        "1991-06-25".into(), "Ride Manager".into(), 6000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "RIM-004".into(), "Nina Foster".into(), "nina.foster@vortekia.com".into(), 
                        "1992-08-05".into(), "Ride Manager".into(), 6000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "RIM-005".into(), "Oliver King".into(), "oliver.king@vortekia.com".into(), 
                        "1993-10-14".into(), "Ride Manager".into(), 6000.00.into(), None::<String>.into(),
                    ])
                    // Ride Staff (5 Users)
                    .values_panic([ 
                        "RIS-001".into(), "James Wong".into(), "james.wong@vortekia.com".into(), 
                        "1988-07-19".into(), "Ride Staff".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                    ...
                    .values_panic([ 
                        ...
                        "1988-07-19".into(), "F&B Supervisor".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                    ...
                    .values_panic([ 
                        ...
                        "1988-07-19".into(), "Chef".into(), 2000.00.into(), "RT001".into(),
                    ])
                    .values_panic([ 
                    ...
                    .values_panic([ 
                        ...
                        "1988-07-19".into(), "Chef".into(), 2000.00.into(), "RT002".into(),
                    ])
                    .values_panic([ 
                        "CHF-004".into(), "James Wong".into(), "james.wong013@vortekia.com".into(), 
                        "1988-07-19".into(), "Chef".into(), 2000.00.into(), "RT003".into(),
                    ])
                    .values_panic([ 
                        "CHF-005".into(), "James Wong".into(), "james.wong014@vortekia.com".into(), 
                        "1988-07-19".into(), "Chef".into(), 2000.00.into(), "RT004".into(),
                    ])
                    // Waiter (5 Users)
                    .values_panic([ 
                        "WTR-001".into(), "James Wong".into(), "james.wong015@vortekia.com".into(), 
                        "1988-07-19".into(), "Waiter".into(), 2000.00.into(), "RT001".into(),
                    ])
                    .values_panic([ 
                    ...
                    .values_panic([ 
                        ...
                        "1992-09-23".into(), "Sales Associate".into(), 5000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                    ...
                    .values_panic([ 
                        ...
                        "1988-07-19".into(), "Maintenance Manager".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                    ...
                    .values_panic([ 
                        ...
                        "1988-07-19".into(), "Maintenance Staff".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "MAS-002".into(), "Ethan Lau".into(), "ethan.lau@vortekia.com".into(), 
                        "1989-05-12".into(), "Maintenance Staff".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "MAS-003".into(), "Ryan Ng".into(), "ryan.ng@vortekia.com".into(), 
                        "1991-08-30".into(), "Maintenance Staff".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "MAS-004".into(), "Liam Chen".into(), "liam.chen@vortekia.com".into(), 
                        "1990-02-14".into(), "Maintenance Staff".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .values_panic([ 
                        "MAS-005".into(), "Samuel Tan".into(), "samuel.tan@vortekia.com".into(), 
                        "1992-11-21".into(), "Maintenance Staff".into(), 2000.00.into(), None::<String>.into(),
                    ])
                    .to_owned(),
            )
            .await?;
